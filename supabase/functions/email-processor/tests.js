// Script de testes para a Edge Function email-processor
// Execute com: node tests.js

// Importa o módulo fetch
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));

// Configurações
const BASE_URL = 'http://localhost:54321/functions/v1/email-processor';
// Este é um token fictício para testes (em produção, use um token JWT real)
const AUTH_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJhbm9uIiwiZXhwIjoxOTcxMDg4MTgwfQ.FnHyBe93brfQJFZGp0FZTtLUZm_kYvyuHVJ_GwQn5Dw';
const EMAIL_ACCOUNT_ID = '123e4567-e89b-12d3-a456-426614174000'; // UUID fictício da conta de email
