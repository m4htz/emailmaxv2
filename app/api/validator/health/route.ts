...
/**
 * Endpoint proxy para verificação de saúde do validador de email
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${VALIDATION_SERVICE_URL}/api/health?detailed=${detailed}`, {
      method: 'GET',
      headers: {
    ...
    console.error('[API Proxy] Erro ao acessar serviço de saúde:', error);
